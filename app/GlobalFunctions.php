...
function generateDynamicTable($data, $actions, $rem = [], $MustHave = [], $TableClass = "mytable")
{
    ...
    $output .= '<thead><tr class="text-gray-800 border-gray-200 fw-bold border-bottom">';
...
{
    echo ' <div class="bg-white modal fade"  id="Update' .
        $ModalID .
        '" style="height:800px">
...
function _UpdateModalFooter()
{
    ...
    <div class="modal-footer">
        <button type="button" class="shadow-lg btn btn-danger"
            data-bs-dismiss="modal">Close</button>
        <button   data-bs-dismiss="modal" id="UpdateFormButton" type="submit" class="shadow-lg btn btn-dark">Update
            Record</button>
...
function UpdateModalFooter()
{
    ...
    <div class="modal-footer">
        <button type="button" class="shadow-lg btn btn-danger"
            data-bs-dismiss="modal">Close</button>
        <button   data-bs-dismiss="modal" type="submit" class="shadow-lg btn btn-dark">Update
            Record</button>
...
{
    echo '  <button type="button" class="mx-1 mb-2 btn float-end ' .
        $BtnClass .
        ' ' .
        $Class .
...
{
    echo '  <button type="button" class="mx-1 mb-2 btn float-end btn-sm ' .
        $Class .
    ...
    foreach ($ArrayData as $data) {
        ...
        $data->{$col} .
            '
                ...
                <div class="modal-footer">
                    <button type="button" class="shadow-lg btn btn-dark" data-bs-dismiss="modal">Close</button>
...
{
    echo ' <div class="mt-3 mb-3 col-md-4 ">
    <div class="mb-3">
        <label class="required form-label">' .
        $label .
        '</label>
...
{
    echo '  <div class="mt-3 mb-3 col-md-12">
      <div class="mb-3">
      <label class="required form-label">' .
        $label .
        '</label>
